...
import { collection, collectionGroup, onSnapshot, query, where, orderBy, doc, updateDoc } from 'firebase/firestore'
...
export default function AdminMembers() {
  ...
  // Email and phone live in users/{uid}/private/contact, readable only by the board.
  useEffect(() => onSnapshot(collectionGroup(db, 'private'), s => setContacts(Object.fromEntries(s.docs.map(d => [d.ref.parent.parent.id, d.data()]))), console.error), [])
